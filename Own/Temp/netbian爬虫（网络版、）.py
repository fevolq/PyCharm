#网址：http://pic.netbian.com/tupian/24770.html
#下载图片地址：http://pic.netbian.com/downpic.php?id=24770&classid=54
...
class Spider:
    def __init__(self):
        ...
        # 每天限量只能下载200张
        self.downCount = 0
        self.ddir = 'C:\\Users\\15394\\Desktop\\netbian\\'

    def readCookies(self):
        cookies = {}
        with open("C:\\Users\\15394\\Desktop\\c.txt", "r", encoding="utf-8") as f:
            while True:
                c = f.readline()
                if c is not None:
                    c = c.strip()
